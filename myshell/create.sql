...
(
    ...
    std_dev                double comment '标准差'        default null,
    std_dev_max            double comment '标准差指标上限'    default null,
    std_dev_min            double comment '标准差指标下限'    default null,
    consistency_table      varchar(20) comment '一致性父表' default null,
    consistency_dev        int comment '数据量差额'         default null,
